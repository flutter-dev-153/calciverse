...
class CoFactorsOfAMatrixScreen extends StatefulWidget {
  static const routeName = '/co-factors-of-matrix';

  @override
  _CoFactorsOfAMatrixScreenState createState() =>
      _CoFactorsOfAMatrixScreenState();
}

class _CoFactorsOfAMatrixScreenState extends State<CoFactorsOfAMatrixScreen> {
...
//        ];
        ...
        valuesMapping = {
//          '2 x 2': twoByTwoMatrix,
          '3 x 3': threeByThreeMatrix,
        };
      });
    });
  }
...
//        '2 x 2',
  ...
  void calculate(BuildContext ctx) {
    ...
    var matrixResult = matrix.coFactors();
    setState(() {
      isSolvable = true;
      result = [
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(title: const Text('Co-Factors of matrix')),
